(function($){
    $.fn.dualSlider=function(options){
        var defaults={auto:true,autoDelay:10000,easingCarousel:'swing',easingDetails:'easeOutBack',durationCarousel:1000,durationDetails:600};
        ...
        this.each(function(){
            ...
            if(options.auto==true){
                ...
                $(".previous",obj).hide();$(".play, .pause",obj).hide()
            }
